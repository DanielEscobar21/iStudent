            ...
            <div class="row">
                <div class="col-md-11">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <a href="{{ route('maestros.materias.edit', $materia) }}" class="btn btn-primary">
                ...
                <div class="col-xl-5 order-xl-2 mb-5 mb-xl-0">
                    <div class="card card-profile shadow">
                        <div class="card-body text-center ">
                            ...
                            <a href="{{ route('maestros.materias.alumnos.index', $materia->id) }}"
                        ...
                        <div class="card-body text-center ">
                            <h1>Clases</h1>
                            <a href="{{ route('maestros.materias.clases.index', $materia->id) }}"
                                class="btn-block btn btn-primary btn-sm">
                            ...
                            <div class="row">
                                <div class="col">
                                    <a class="btn btn-primary btn-sm btn-block"
                                        href="{{ route('maestros.materias.posts.create', $materia->id) }}">
                                        <i class="fas fa-edit"></i> Nueva Publicación
                                    </a>
                                </div>
                                <div class="col">
                                    <a class="btn btn-primary btn-sm btn-block" href="#">
                                        <i class="fas fa-users"></i> Nueva Tarea
                                    </a>
                                </div>
                            </div>
                        </div>
