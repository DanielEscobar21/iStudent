...
class ClaseController extends Controller
{
    public function index($id)
    {
        ...
        return view('maestros.materias.clases.index', compact('materia','clases'));  
    }
    public function create($id)
    {   
        $materia=Materia::find($id);
        return view('maestros.materias.clases.create', compact('materia'));  
    }
    ...
    {   
        ...
        $clase = Clase::find($id);
        return view('maestros.materias.clases.show', compact('materia','clase'));   
    }
